#include<bits/stdc++.h>
using namespace std;
// Using this concept we can create a complex node as per our requirement.
// We are here provided a complex node.
//For each of the node object there are neighbours defined.
...
//Here the vertices of the graph are named.
class Graph{
	//All nodes
