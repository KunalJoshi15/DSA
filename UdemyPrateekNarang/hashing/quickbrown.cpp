...
// string words[] = {"the","fox","thequickbrownfox","jumps","lazy","lazyfox","highbridge","the","over","bridge","tall","quick","brown"};
string words[] = {"the","over","theover"};
/*
The approach that will be used in this particular question is 
*/
